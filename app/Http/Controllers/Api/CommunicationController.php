...
class CommunicationController extends Controller
{
    ...
    public function sendableCases(int $id)
{
    $result = $this->service->listSendableCases($id);
...
public function sendableInvoices(int $id)
{
    $result = $this->service->listSendableInvoices($id);
