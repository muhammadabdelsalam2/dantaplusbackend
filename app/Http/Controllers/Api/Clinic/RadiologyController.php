...
class RadiologyController extends Controller
{
    ...
    public function downloadPdf($radiologyId)  // ⭐ غيّر من int
    {
        return $this->respond($this->service->downloadPdfLink((int) $radiologyId));  // ⭐ cast إلى int
    }

    public function pdfFile($radiologyId)  // ⭐ غيّر من int
    {
        $result = $this->service->downloadPdf((int) $radiologyId);  // ⭐ cast إلى int
